...
const Contact = ()=>{
    return (
        <div id="contact" className='max-w-[1040px] m-auto md:pl-20 py-16 snap-start'>
            <h1 className="py-4 text-4xl font-bold text-center text-[#001b5e]">
                Contact
            </h1>
            <form action = "https://getform.io/f/30b4d3d8-eced-43a3-a6a9-8d84de32a7ee" method='POST' encType="multipart/form-data">
